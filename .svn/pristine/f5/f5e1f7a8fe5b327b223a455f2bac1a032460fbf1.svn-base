...
<html>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("a[class='transform']").click(function(){
				...
				$("#vimg").attr("src", "AuthCodeServlet.do?"+cursor);
			});
  ...
  <body>
    <div class="header-1">
		<div class="container">
			<a href="index.html" class="lo1"><img src="<%=basePath%>/images/logo.png"></a>
	...
	<div class="content">
		<div class="container clear">
			<!-- 登录表单 -->
			<form class="fr1" action="LoginServlet.do" method="post">
				<div class="left ad1">
					<img src="<%=basePath%>/images/ad/1.jpg" alt="">
				</div>
				<div class="right login-dialog">
					...
					<p class="p5">
						...
						<img src="AuthCodeServlet.do" id="vimg" alt="验证码"/>
