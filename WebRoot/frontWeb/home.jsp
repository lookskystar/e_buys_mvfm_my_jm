...
<html>
  <head>
	...
	<link rel="stylesheet" href="<%=basePath%>frontWeb/css/index.css"/>
	...
	<!-- 引入自定义的日期插件 -->
	<script type="text/javascript" src="<%=basePath%>frontWeb/js/jquery-timer-1.0.js"></script>
	...
	<div class="header">
				...
				<div class="left">
					...
					<span>
						<% 
							if(user != null){
						%>
							<a href="customer/logout.do">注销</a>
						<%		
							}else{
						%>
					...
					<a href="<%=basePath%>frontWeb/register.jsp">免费注册</a>
				</div>
		...
		<div class="search-logo">	
			<div  class="clear container">
				<a href="#" class="left lo1"><img src="<%=basePath%>frontWeb/images/logo.png" alt=""></a>
			...
			<ul class="nav-menu">
				...
				<li>
					...
					<div  class="sub-Menu tc"> 
						<div class="lx_">
							<img src="<%=basePath%>frontWeb/images/6.jpg"><a href=""><span>女装</span></a>
						</div>
						...
						<div class="lx_">
							<img src="<%=basePath%>frontWeb/images/7.jpg"><a href=""><span>女鞋</span></a>
						</div>
						<div class="xl_ clear" id="xl_">
							<a href="">夏新品</a>
							<a href="">夏新品</a>
	...
	<div class="banner">
		...
		<div class="banner-wrap">
			<ul id="ul_img_ad" class="clear">
				<li><a href="#"><img style="width:1440px;" src="<%=basePath%>frontWeb/images/banner/1.jpg"></a></li>
				<li><a href="#"><img style="width:1440px;" src="<%=basePath%>frontWeb/images/ad/3.jpg"></a></li>
				<li><a href="#"><img style="width:1440px" src="<%=basePath%>frontWeb/images/ad/4.jpg"></a></li>
				<li><a href="#"><img style="width:1440px" src="<%=basePath%>frontWeb/images/ad/5.jpg"></a></li>
				<li><a href="#"><img style="width:1440px" src="<%=basePath%>frontWeb/images/ad/6.jpg"></a></li>
			</ul>
		</div>
		<div class="container">
			<!-- 向左 -->
		...
		<div class="container">
			<div class="section">
				...
				<div class="clear bg-white pr1">
					<a href="#" class="left img-bg"><img src="<%=basePath%>frontWeb/images/product/1.jpg" alt=""></a>
					<ul class="right">
						<li class="clear qg_">
							<a href="details.html" class="left l1"><img src="<%=basePath%>frontWeb/images/product/2.jpg" alt=""></a>
						...
						<li class="clear qg_">
							<a href="details.html" class="left l1"><img src="<%=basePath%>frontWeb/images/product/3.jpg" alt=""></a>
							<span class="text-top left">
								<a href="details.html">三星<br>GALAXY S6<br>Edge</a>
								<p>抢码价：</p>
								<p class="f18 bg-c40000 white">¥6800</p>
						...
						<li class="clear qg_">
							<a href="details.html" class="left l1"><img src="<%=basePath%>frontWeb/images/product/4.jpg" alt=""></a>
							<span class="text-top left">
								<a href="details.html">三星<br>GALAXY S6<br>Edge</a>
								<p>抢码价：</p>
								<p class="f18 bg-c40000 white">¥6800</p>
						...
						<li class="clear qg_">
							<a href="details.html" class="left l1"><img src="<%=basePath%>frontWeb/images/product/5.jpg" alt=""></a>
							<span class="text-top left">
								<a href="details.html">三星<br>GALAXY S6<br>Edge</a>
								<p>抢码价：</p>
								<p class="f18 bg-c40000 white">¥6800</p>
						...
						<li class="clear qg_">
							<a href="details.html" class="left l1"><img src="<%=basePath%>frontWeb/images/product/7.jpg" alt=""></a>
							<span class="text-top left">
								<a href="details.html">三星<br>GALAXY S6<br>Edge</a>
								<p>抢码价：</p>
								<p class="f18 bg-c40000 white">¥6800</p>
